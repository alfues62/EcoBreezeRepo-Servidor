...
function enviarCorreoVerificacion($email, $token) {
    ...
    $message = 'asdasdsukdgaksudhjaksdhasjkdhjaksdhajksdhjkasjkh Haz clic en el siguiente enlace para verificar tu correo: http://localhost:8080/backend/registrar/verificar_correo.php?email=' . urlencode($email) . '&token=' . urlencode($token);
