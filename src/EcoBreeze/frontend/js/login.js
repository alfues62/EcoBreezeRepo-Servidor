document.addEventListener("DOMContentLoaded", function() {
    ...
    toggleButton.addEventListener("click", function() {
        const isPasswordVisible = contrasenaInput.type === "text";
        contrasenaInput.type = isPasswordVisible ? "password" : "text";
        toggleButton.innerHTML = isPasswordVisible ? eyeIcons.open : eyeIcons.closed;
    });
    ...
    if (serverErrorMessage) {
        errorMessageContent.textContent = serverErrorMessage;
        errorModal.show();
    }
});
